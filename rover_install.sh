...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Rover.conf'
CONFIGFOLDER='/root/.Rover'
COIN_DAEMON='/usr/local/bin/Roverd'
COIN_CLI='/usr/local/bin/Roverd'
COIN_REPO='https://github.com/RoverCoin/Rovercoin/files/1789429/Roverd-.Linux_Daemon.tar.gz'
COIN_NAME='Rover'
COIN_PORT=28218
RPC_PORT=28217
